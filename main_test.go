...
var cases = []struct {
	...
	{"", "feature/1", time.Date(2023, 1, 21, 12, 0, 0, 0, time.UTC), "20230121-01.1"},
	{"", "feature/12", time.Date(2023, 1, 21, 12, 0, 0, 0, time.UTC), "20230121-01.12"},
	{"", "feature/1-test", time.Date(2023, 1, 21, 12, 0, 0, 0, time.UTC), "20230121-01.1"},
	{"", "feature/12-test", time.Date(2023, 1, 21, 12, 0, 0, 0, time.UTC), "20230121-01.12"},
